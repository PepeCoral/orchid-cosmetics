...
class CatalogView(View):
    ...
    def get(self, request):
        ...
        # Determinar pestaña activa: primero parámetro GET, luego session, luego por defecto
        active_tab = request.GET.get('tab')
        if active_tab:
            # Guardar en session para futuras visitas
            request.session['active_catalog_tab'] = active_tab
        else:
            # Usar session o valor por defecto
            active_tab = request.session.get('active_catalog_tab', 'products')
    ...
    def post(self, request):
        ...
        # Guardar la pestaña activa en session
        request.session['active_catalog_tab'] = search_type
